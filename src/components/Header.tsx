            ...
            <div className="flex justify-between p-5 items-center">
                ...
                <div className="flex gap-3 items-center">
                    <p className="w-10 h-10 rounded-full bg-yellow-default">
                        <img className="h-full w-full rounded-full" src={`${userCtx?.user?.image_url ? `http://localhost/controle-fitness/backend/uploads/${userCtx?.user?.image_url}` : 'http://localhost/controle-fitness/backend/uploads/avatar.jpg'}`} alt="" />
                    </p>
